  ...
  methods: {
    ...
    isExpandCell(table, columnIndex) {
      return table.expandType && (
        // (table.showIndex && columnIndex === 4) ||
        // (!table.showIndex && columnIndex === 3) ||
        (table.showIndex && columnIndex === table.expandColumnNum + 1) ||
        (!table.showIndex && columnIndex === table.expandColumnNum)
      );
    },
